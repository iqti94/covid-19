...
def overview():
    ...
    over.wm_iconbitmap("icn.ico")
    bckimg=ImageTk.PhotoImage(Image.open("bck1.jpg"))
    ...
    def talk():
        ...
        engine.runAndWait()
        engine.stop()
    btnimg=ImageTk.PhotoImage(Image.open("img12.png"))
...
def Cases():
    ...
    case.wm_iconbitmap("icn.ico")
    bckimg1=ImageTk.PhotoImage(Image.open("bck2.jpg"))
...
def deaths():
    ...
    close.wm_iconbitmap("icn.ico")
    bckimg2=ImageTk.PhotoImage(Image.open("bck3.jpg"))
...
def countries_affected():
    ...
    ctn.wm_iconbitmap("icn.ico")
    ctnimg=ImageTk.PhotoImage(Image.open("cntry1.jpg"))
...
def testprocess():
    ...
    root.title("Login")
    root.wm_iconbitmap("icn.ico")
    loginimage=ImageTk.PhotoImage(Image.open("login.jpg"))
...
lblimg=ImageTk.PhotoImage(Image.open("logo2.png"))
...
image1=ImageTk.PhotoImage(Image.open("img2.jpg"))
image2=ImageTk.PhotoImage(Image.open("img3.jpg"))
image3=ImageTk.PhotoImage(Image.open("img4.jpg"))
image4=ImageTk.PhotoImage(Image.open("img5.jpg"))
image5=ImageTk.PhotoImage(Image.open("img6.jpg"))
image6=ImageTk.PhotoImage(Image.open("img7.png"))
image7=ImageTk.PhotoImage(Image.open("img8.jpg"))
image8=ImageTk.PhotoImage(Image.open("img9.png"))
image9=ImageTk.PhotoImage(Image.open("img10.jpg"))
...
frameimg=ImageTk.PhotoImage(Image.open("dashboard.jpg"))
...
icnlblimg=ImageTk.PhotoImage(Image.open("world-icon (1).png"))
...
icnlblimg1=ImageTk.PhotoImage(Image.open("case-icon.png"))
...
icnlblimg2=ImageTk.PhotoImage(Image.open("Close-2-icon.png"))
...
icnlblimg3=ImageTk.PhotoImage(Image.open("Country-icon.png"))
...
icnlblimg4=ImageTk.PhotoImage(Image.open("Color-MS-Excel-icon.png"))
...
icnlblimg5=ImageTk.PhotoImage(Image.open("Skull-and-bones-icon.png"))
...
icnlblimg6=ImageTk.PhotoImage(Image.open("uxwing-svg-icon-editor (1).png"))
...
icnlblimg7=ImageTk.PhotoImage(Image.open("uxwing-svg-icon-editor (3).png"))
...
icnlblimg8=ImageTk.PhotoImage(Image.open("test process.png"))
...
icnlblimg9=ImageTk.PhotoImage(Image.open("quit.png"))
...
daymde=ImageTk.PhotoImage(Image.open("dark.jpg"))
...
nghtmde=ImageTk.PhotoImage(Image.open("nightmode.jpg"))
